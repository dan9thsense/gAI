    ...
    def runNet(self):
      ...
      while True:           
        ...
        if np.random.rand(1) < self.e:
          ...
          self.action = sess.run(self.myAgent77.chosen_action,feed_dict={self.myAgent77.state_in:[self.currentState]})
        ...
        #Update the network
        feed_dict={self.myAgent77.reward_holder:[self.reward],self.myAgent77.action_holder:[self.action],self.myAgent77.state_in:[self.previousState]}
        _,ww = sess.run([self.myAgent77.update, self.weights77], feed_dict=feed_dict)
