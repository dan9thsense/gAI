    ...
    def runNet(self):
      ...
      with tf.Session() as sess:
          ...
          while True:           
            ...
            #_,ww = sess.run([self.myAgent.update, self.myAgent.weights], feed_dict=feed_dict)
            
            #Update the network.
            #_,resp,ww = sess.run([self.myAgent.update, self.myAgent.responsible_weight, self.weights], feed_dict={self.myAgent.reward_holder:[self.reward],self.myAgent.action_holder:[self.action]})
