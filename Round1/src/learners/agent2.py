    ...
    def runNet(self):
      ...
      while True:           
        ...
        if np.random.rand(1) < self.e:
          ...
          self.action = sess.run(self.myAgent88.chosen_action,feed_dict={self.myAgent88.state_in:[self.currentState]})
        ...
        #Update the network
        feed_dict={self.myAgent88.reward_holder:[self.reward],self.myAgent88.action_holder:[self.action],self.myAgent88.state_in:[self.previousState]}
        _,ww = sess.run([self.myAgent88.update, self.weights88], feed_dict=feed_dict)
