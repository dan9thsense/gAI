...
class simpleAgent(Responder):
    ...
    def runNet(self):
        ...
        while True:
            ...
            _, self.weightValues, loss, output, hiddenOutput, selOutput, self.statesToActions = self.sess.run([self.myAgent.update, self.weights,\
                self.myAgent.loss, self.myAgent.output, self.myAgent.hiddenOutput, self.myAgent.selected_output, self.states_to_actions],\
